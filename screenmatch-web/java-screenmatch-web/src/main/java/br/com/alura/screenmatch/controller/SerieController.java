...
public class SerieController {
    ...
    @GetMapping("/categoria/{categoriaGenero}")
    public List<SerieDTO> obterSeriesPorCategoria(@PathVariable String categoriaGenero) {
        return service.obterSeriesPorCategoria(categoriaGenero);
    }
}
