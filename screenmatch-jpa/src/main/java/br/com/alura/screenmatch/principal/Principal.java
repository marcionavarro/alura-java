...
public class Principal {
    ...
    private void buscarSerieWeb() {
        ...
        boolean existe = serieRepository.existsByTituloIgnoreCase(dados.titulo());
    ...
    private DadosSerie getDadosSerie() {
        ...
        if (dados.response().equalsIgnoreCase("False")) {
    ...
    private void buscarSeriePorAtor() {
        ...
        List<Serie> seriesEncntradas = serieRepository.findByAtoresContainingIgnoreCaseAndAvaliacaoGreaterThanEqual(
            nomeAtor, avaliacao);

        if (seriesEncntradas.isEmpty()) {
            System.out.println("Não existe séries com o ator: " + nomeAtor);
            return;
        }

        System.out.println("Séries em que " + nomeAtor + "trabalhou");
        seriesEncntradas.forEach(s -> System.out.println(s.getTitulo() + " | avaliações " + s.getAvaliacao()));
    }
    ...
    private void filtrarSeriesPorTemporadaEAvaliacao() {
        ...
        var avaliacao = leitura.nextDouble();
        leitura.nextLine();
        List<Serie> filtroSeries = serieRepository.findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(
            totalTemporadas,
            avaliacao);
